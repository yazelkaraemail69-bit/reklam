...
export function BusinessesShowcaseSection({ businesses }: { businesses: Business[] }) {
  ...
  return (
    <section id="ornekler" className="bg-slate-50 py-20 sm:py-28">
      <div className="container-app">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h2 className="mt-3 text-3xl font-black text-emerald-950 sm:text-4xl">
            Kampanyaların yönlendirdiği vitrinler
          </h2>
          <p className="mt-3 text-base text-slate-600">
            Reklam tıklamaları buraya düşer — işletmenin mobil uyumlu tanıtım sayfası.
          </p>
        </div>
